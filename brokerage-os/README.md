...
A fulfillment engine for a practice-brokerage desk. Five stations take the work that used to sit in one person's queue. The broker still makes the call.

It installs onto the firm's CRM, documents, and escrow process.
...
Each station is a specialist agent. It takes in what the desk already has and returns a packet someone can act on. A person signs off before anything leaves the building.

## See it

- [The fulfillment engine](stations.md) — one file, all the way through
- [How it's built](how-its-built.md) — their stack, their judgment, their instance
- [Walkthrough](walkthrough.md) — what it feels like to sit with the desk
